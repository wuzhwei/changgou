...
public class UrlFilter {
     ...
     * 所有需要传递令牌的地址
     */
    public static String filterPath = "/api/wlogistics/**,/api/logistics/**,/api/echarts/**,/api/wuser/**,/api/worder/**,/api/wseckillorder,/api/seckill,/api/wxpay,/api/wxpay/**,/api/worder/**,/api/user/**,/api/address/**,/api/wcart/**,/api/cart/**,/api/categoryReport/**,/api/orderConfig/**,/api/order/**,/api/orderItem/**,/api/orderLog/**,/api/preferential/**,/api/returnCause/**,/api/returnOrder/**,/api/returnOrderItem/**";
